    ...
    <div className="pt-5">
      <div className="w-full flex justify-center items-center h-[250px] bg-gradient-to-r from-[#4c76cf] to-[#552ab8] relative rounded-md overflow-hidden">
        <button
          ...
          className="px-4 py-2 text-[15px] overflow-hidden text-center bg-[#8b3dffad] 
          text-white rounded-[3px] font-medium hover:bg-[#8b3dffd3] absolute top-3 right-3"
        >
          Custom size
        </button>
        <div
              ...
              <div className="relative group w-full h-[150px] px-2" key={i}>
                <Link className="w-full h-full block bg-[#ffffff12] p-4 rounded-md">
                  <img
                    ...
                    src="http://localhost:5173/rasel.png"
                    alt=""
                  />
                </Link>
