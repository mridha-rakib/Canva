        ...
        <div className="w-[350px] bg-[#323335] m-auto px-6 py-4 rounded-md relative ">
          ...
          {type === "signin" && (
            <form>
              ...
              <div className="flex py-4 justify-content-between items-center px-3">
              ...
              <div className="pb-4">
                <button className="px-3 flex justify-center items-center gap-2 py-3 rounded-md bg-orange-700 w-full text-white outline-none  hover:bg-orange-800 ">
                  <span className="">
                    <AiOutlineGoogle />
                  </span>
              ...
              <div>
                <button className="px-3 flex justify-center items-center gap-2 py-3 rounded-md bg-blue-700 w-full text-white outline-none  hover:bg-blue-800 ">
                  <span className="">
                    <FaFacebook />
                  </span>
